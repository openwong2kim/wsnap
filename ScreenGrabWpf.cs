...
/// <summary>WPF half of ScreenGrab (the grabbing half is framework-agnostic and linked into
/// Wsnap.Avalonia, which has its own AvImaging converter instead of this).</summary>
