...
public static class L
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["tray.updateAvailable"] = "Download v{0}…",
        ["tray.exit"]           = "Exit",
        ...
        ["toast.upToDate"]      = "wsnap is up to date (v{0})",
        ["toast.updateAvailable"] = "wsnap v{0} is available — see the tray menu",
        ["toast.updateCheckFailed"] = "Couldn't check for updates",
        ...
        ["set.cardVideo"]       = "Video recording",
        ["set.videoFps"]        = "Frame rate",
        ["set.videoAudio"]      = "Audio (MP4 only)",
        ["set.audioNone"]       = "None (silent)",
        ["set.audioMic"]        = "Microphone",
        ["set.audioSystem"]     = "System audio",
        ["set.audioBoth"]       = "Mic + system",
        ["set.audioHint"]       = "System audio needs a wasapi-enabled ffmpeg; otherwise it is skipped.",
        ...
        ["vid.audioUnavailable"] = "Audio source unavailable — recorded without sound",
    ...
    private static readonly Dictionary<string, string> Ko = new()
    {
        ...
        ["toast.upToDate"]      = "wsnap 최신 버전입니다 (v{0})",
        ["toast.updateAvailable"] = "wsnap v{0} 사용 가능 — 트레이 메뉴 확인",
        ...
        ["set.cardVideo"]       = "영상 녹화",
        ["set.videoFps"]        = "프레임 속도",
        ["set.videoAudio"]      = "오디오 (MP4만)",
        ["set.audioNone"]       = "없음 (무음)",
        ["set.audioMic"]        = "마이크",
        ["set.audioSystem"]     = "시스템 오디오",
        ["set.audioBoth"]       = "마이크 + 시스템",
        ["set.audioHint"]       = "시스템 오디오는 wasapi 지원 ffmpeg가 필요하며, 없으면 건너뜁니다.",
        ["set.cardLanguage"]    = "언어",
        ["set.language"]        = "표시 언어",
        ...
        ["vid.audioUnavailable"] = "오디오 소스 사용 불가 — 소리 없이 녹화함",
